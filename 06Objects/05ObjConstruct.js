// Q.create three objects having the difeerent name and function saying hello
...
welcome.call(human1, 25, 1999); 
// first one should be the object,from that we will log the values in the welcome function . ,, then arguments for the function, ..... here we are just attaching the function to the objects
...
console.log(`way3 apply 
    `);
//syntax -  function.apply(object, [argument1,argument2,...]) // syntax for apply ...here arguments are passed in the form of array ..
...
console.log("--1--");
const resultBind = welcome.bind(human1, 22, 2001); //first argument object should pass compulsary.
console.log(resultBind); // it will give the function 
...
function User(name, age) {
  // console.log(`hello user `,this) // this refers to the current function
  this.name = name;
  this.age = age;
  // console.log('first')
  this.greet = function () {
